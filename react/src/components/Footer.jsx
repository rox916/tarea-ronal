    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-grid">
          <div>
            <h3 className="footer-title">Tienda en Linea</h3>
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li>
                <Link to="/?category=clothing" className="footer-link">
                  Ropa
                </Link>
              </li>
              <li>
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="#" className="footer-link" onClick={(e) => {
                  e.preventDefault();
                  document.querySelector('button[aria-label="Contacto"]').click();
                }}>
                  Contacto
                </a>
              </li>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; {new Date().getFullYear()} TiendaOnline. Todos los derechos reservados.
          </p>
